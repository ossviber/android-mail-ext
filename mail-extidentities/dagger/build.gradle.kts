...
android {
    namespace = "ch.protonmail.android.extidentities.dagger"
...
dependencies {
    ...
    implementation(project(":mail-extidentities:data"))
    implementation(project(":mail-extidentities:domain"))
    implementation(project(":mail-extidentities:presentation"))
}
