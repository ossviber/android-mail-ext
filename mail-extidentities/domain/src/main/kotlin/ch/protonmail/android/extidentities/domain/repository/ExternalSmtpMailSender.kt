...
/**
 * Sends a fully materialized message through an external identity's own SMTP server.
 * Implementations resolve and unseal credentials inside the data layer; callers never
 * see secrets.
 */
interface ExternalSmtpMailSender {
